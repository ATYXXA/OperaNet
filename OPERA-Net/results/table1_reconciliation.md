...
| Model | Input Feature | CtrSVDD EER (%) | CtrSVDD min-tDCF | SingFake EER (%) | SingFake min-tDCF |
|---|---|---|---|---|---|
| RawNet2 [5] | Raw Waveform (Sinc) | 9.85 | 0.285 | 15.42 | 0.452 |
| AASIST [4] | Raw Waveform (Sinc) | 6.42 | 0.186 | 8.35 | 0.211 |
| WavLM-Linear [8] | WavLM Base+ | 3.95 | 0.114 | 5.80 | 0.165 |
| OPERA-Net (Ours) | PC-CQT + WavLM | 1.54 | 0.045 | 3.68 | 0.092 |

### Table 1（本仓库实测值）

| Model | Input Feature | CtrSVDD EER (%) | CtrSVDD min-tDCF | SingFake EER (%) | SingFake min-tDCF |
|---|---|---|---|---|---|
| RawNet2 [5] | Raw Waveform (Sinc) | — | — | — | — |
| AASIST [4] | Raw Waveform (Sinc) | — | — | — | — |
| WavLM-Linear [8] | WavLM Base+ | — | — | — | — |
| OPERA-Net (Ours) | PC-CQT + WavLM | — | — | — | — |

### Table 1（逐格对照：`论文值 → 实测值 (Δ)`）

| Model | CtrSVDD EER (%) | CtrSVDD min-tDCF | SingFake EER (%) | SingFake min-tDCF |
|---|---|---|---|---|
| RawNet2 [5] | 9.85 → 未跑 | 0.285 → 未跑 | 15.42 → 未跑 | 0.452 → 未跑 |
| AASIST [4] | 6.42 → 未跑 | 0.186 → 未跑 | 8.35 → 未跑 | 0.211 → 未跑 |
| WavLM-Linear [8] | 3.95 → 未跑 | 0.114 → 未跑 | 5.80 → 未跑 | 0.165 → 未跑 |
| OPERA-Net (Ours) | 1.54 → 未跑 | 0.045 → 未跑 | 3.68 → 未跑 | 0.092 → 未跑 |
